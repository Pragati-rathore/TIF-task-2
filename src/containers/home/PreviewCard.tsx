    ...
    <Box p="1rem">
      <Box borderRadius="10px" bgColor="gray.100" height="fit-content">
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          ...
          <DataCard title="Job Detail">
            <KeyValue title="Job Title" value={userInputJob.jobTitle} />
            <KeyValue title="Job Details" value={userInputJob.jobDetails} />
            <KeyValue title="Job Location" value={userInputJob.jobLocation} />
          </DataCard>
          <DataCard title="Interview Settings">
            <KeyValue
              title="Interview Duration"
